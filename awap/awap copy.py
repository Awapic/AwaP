...
##############################################################################
        ...
        # self.dlg.button_box.accepted.connect(self.execute_AwaP_worker_thread)
    ...
    def pushbutton_on_press(self, signal):
        ...
        execAlgorithmDialog('qgis:creategrid', params)
    ...
    def showLayer(self, layer, params):
        ...
        #         attrName=self.dlg.comboBox.value().split(' ')[1],
        #         categories= 
        #     )
    ...
    def execute(self):
        ...
        self.boundary_option_single = self.dlg.radioButton.isChecked()
        if self.boundary_option_single:
            self.log('calculate single AwaP for the entire boundary layer')
        self.boundary_option_multiple = self.dlg.radioButton_2.isChecked()
...
####### HANDLING THE BLOCKS LAYER
        ...
        def calculateAwaP(self, boundary_geom):
            ...
            # self.showLayerSignal.emit(self.final_blocks_layer, {'color' : QColor(128, 55, 55).rgb()})
        ...
        for boundary in self.boundary_layer.getFeatures():
            boundary_geom = boundary.geometry()
            calculateAwaP(self, boundary_geom)
        
        
        # self.dlg.label_9.setVisible(False)


    def execute_AwaP_worker_thread(self):
